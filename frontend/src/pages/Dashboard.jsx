          ...
          <div>
            ...
            {jobsLoading ? (
              <div className="flex gap-4 overflow-x-auto pb-4 snap-x hide-scrollbar">
                {[1, 2, 3].map(i => (
                  <div key={i} className="min-w-[280px] sm:min-w-[320px] bg-white rounded-2xl p-5 border border-slate-100 shadow-sm animate-pulse snap-start">
              ...
              <div className="flex gap-4 overflow-x-auto pb-4 snap-x hide-scrollbar">
                {recommendedJobs.map((job) => (
                  <div
                    key={job.id}
                    className="min-w-[280px] sm:min-w-[320px] bg-white rounded-2xl p-5 border border-slate-100 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300 flex flex-col snap-start"
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-100 to-green-50 flex items-center justify-center shrink-0">
                    ...
                    <p className="text-xs font-semibold text-[#0076BC] mb-3">{job.company}</p>
                    <div className="flex items-center gap-2 mb-4 mt-auto">
                      <span className="flex items-center gap-1 text-[10px] text-slate-500 bg-slate-50 border border-slate-100 px-2 py-1 rounded-full font-medium">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-1.5 bg-slate-50 text-slate-700 font-semibold py-2 rounded-xl hover:bg-[#0076BC] hover:text-white transition shadow-sm text-xs border border-slate-200"
                    >
